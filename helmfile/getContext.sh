...
getValue "PUBLIC_NGINX_TARGET_GROUP_ARN"
getValue "INTERNAL_DNS_FQDN"
getValue "ADMIN_TARGET_GROUP_ARN"
getValue "CERT_MANAGER_ROUTE53_ZONE_ID"
getValue "CERT_MANAGER_ROUTE53_IRSA_ROLE_ARN"
getValue "CERT_MANAGER_ROUTE53_ROLE_ARN"
...
getValue "MANIFEST_NEW_RELIC_LICENSE_KEY"
