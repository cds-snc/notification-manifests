...
echo "This script will create secondary services for Admin, API, DocDownload, and Documentation."
...
if [ "$RESPONSE" == "yes" ]; then
    ...
    echo "Creating Secondary Services..."
    runCommand "kubectl apply -f services.yaml"
    echo "Done."
    echo "Creating Secondary TargetGroup Bindings"
    runCommand "kubectl apply -f targetGroups.yaml"
    echo "Done."
    popd
    exit 0
else
